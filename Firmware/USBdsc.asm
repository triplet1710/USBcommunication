...
;USBdsc.c,163 :: 		void USB_Init_Desc(){
;USBdsc.c,164 :: 		USB_config_dsc_ptr[0] = &configDescriptor1;
...
;USBdsc.c,165 :: 		USB_string_dsc_ptr[0] = (const char*)&strd1;
	MOVLW       _strd1+0
...
;USBdsc.c,166 :: 		USB_string_dsc_ptr[1] = (const char*)&strd2;
	MOVLW       _strd2+0
...
;USBdsc.c,167 :: 		USB_string_dsc_ptr[2] = (const char*)&strd3;
	MOVLW       _strd3+0
